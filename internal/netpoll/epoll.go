...
// Trigger wakes up the poller blocked in waiting for network-events and run jobs in asyncJobQueue.
...
// AddReadWrite registers the given file-descriptor with readable and writeable events to the poller.
...
// AddWrite registers the given file-descriptor with writeable event to the poller.
...
// ModReadWrite renews the given file-descriptor with readable and writable event in the poller.
